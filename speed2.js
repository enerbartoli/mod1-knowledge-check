...
const LS_KEY            = 'speed2_quiz_state';

// No answer key, no correct letters and no rationales live in this file. The quiz is
// scored server-side in backend/apps-script.gs (ANSWER_KEY_SPEED2) and the score comes
...
const QUESTIONS = [
  {
    id: 1,
    text: 'At what level does the statistical engine produce the baseline?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Where the baseline is produced',
    section: 'Where the baseline is produced'
  },
  {
    id: 2,
    text: 'Why does the model use adjusted demand rather than shipments alone?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · What feeds the baseline',
    section: 'What feeds the baseline'
  },
  {
    id: 3,
    text: 'The total for one item looks right, but the split across your accounts does not. What does that point to?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Baseline versus disaggregation',
    section: 'Baseline versus disaggregation'
  },
  {
    id: 4,
    text: 'A carry-forward item and a brand-new item both need splitting across accounts. What is different about the new item?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Carry-forward versus new item split',
    section: 'Carry-forward versus new item split'
  },
  {
    id: 5,
    text: 'An account that does not stock an item is showing volume for it. What do you look at first?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · The Forecasting Range',
    section: 'The Forecasting Range'
  },
  {
    id: 6,
    text: 'You expect a one-off volume increase for a specific promotion in a specific week. Where does it belong?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Baseline, enrichment or base trend',
    section: 'Baseline, enrichment or base trend'
  },
  {
    id: 7,
    text: 'In a review someone says “let’s fix this at 2.5”. What are they proposing?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · The level hierarchy',
    section: 'The level hierarchy'
  },
  {
    id: 8,
    text: 'Your portfolio turns over almost completely each year and demand follows entertainment releases rather than repeatable seasons. What does that suggest about a statistical baseline?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Judging statistical fit',
    section: 'Judging statistical fit'
  },
  {
    id: 9,
    text: 'The baseline for one item looks clearly wrong. What is the right first move?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Who owns what',
    section: 'Who owns what'
  },
  {
    id: 10,
    text: 'An account places a single large opportunity buy that will not repeat. If it is left untouched in the item\'s history, what is the risk?',
    options: {
    ...
    slideRefs: 'Speed Training Session 2 · Repeatable versus one-off volume',
    section: 'Repeatable versus one-off volume'
  }
];
